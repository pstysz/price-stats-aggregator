...
import com.stats.aggregator.allegroobj.containers.RemovedItemTemplatesStruct;

public class DoRemoveItemTemplatesResponse  implements java.io.Serializable {
    private RemovedItemTemplatesStruct removedItemTemplates;

    public DoRemoveItemTemplatesResponse() {
    }

    public DoRemoveItemTemplatesResponse(
           RemovedItemTemplatesStruct removedItemTemplates) {
     ...
     */
    public void setRemovedItemTemplates(RemovedItemTemplatesStruct removedItemTemplates) {
        this.removedItemTemplates = removedItemTemplates;
    }

...
import com.stats.aggregator.allegroobj.containers.PaymentsInfoStruct;

public class DoGetMyPaymentsInfoResponse  implements java.io.Serializable {
    private PaymentsInfoStruct paymentsInfo;

    public DoGetMyPaymentsInfoResponse() {
    }

    public DoGetMyPaymentsInfoResponse(
           PaymentsInfoStruct paymentsInfo) {
     ...
     * @param paymentsInfo
     */
    public void setPaymentsInfo(PaymentsInfoStruct paymentsInfo) {
        this.paymentsInfo = paymentsInfo;
    }

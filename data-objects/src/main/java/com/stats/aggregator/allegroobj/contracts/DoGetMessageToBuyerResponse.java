...
import com.stats.aggregator.allegroobj.containers.MessageToBuyerStruct;

public class DoGetMessageToBuyerResponse  implements java.io.Serializable {
    private MessageToBuyerStruct messageToBuyer;

    public DoGetMessageToBuyerResponse() {
    }

    public DoGetMessageToBuyerResponse(
           MessageToBuyerStruct messageToBuyer) {
     ...
     */
    public void setMessageToBuyer(MessageToBuyerStruct messageToBuyer) {
        this.messageToBuyer = messageToBuyer;
    }

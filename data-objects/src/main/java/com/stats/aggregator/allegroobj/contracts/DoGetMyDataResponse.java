...
public class DoGetMyDataResponse  implements java.io.Serializable {
    private UserDataStruct userData;

    private InvoiceDataStruct invoiceData;

    private CompanyExtraDataStruct companyExtraData;

    private CompanySecondAddressStruct companySecondAddress;

    private PharmacyDataStruct pharmacyData;

    private AlcoholDataStruct alcoholData;

    private RelatedPersonsStruct relatedPersons;
    ...
    public DoGetMyDataResponse(
           ...
           InvoiceDataStruct invoiceData,
           CompanyExtraDataStruct companyExtraData,
           CompanySecondAddressStruct companySecondAddress,
           PharmacyDataStruct pharmacyData,
           AlcoholDataStruct alcoholData,
     ...
     * @param userData
     */
    public void setUserData(UserDataStruct userData) {
        this.userData = userData;
    }
     ...
     * @param invoiceData
     */
    public void setInvoiceData(InvoiceDataStruct invoiceData) {
        this.invoiceData = invoiceData;
    }
     ...
     */
    public void setCompanyExtraData(CompanyExtraDataStruct companyExtraData) {
        this.companyExtraData = companyExtraData;
    }
     ...
     */
    public void setCompanySecondAddress(CompanySecondAddressStruct companySecondAddress) {
        this.companySecondAddress = companySecondAddress;
    }
     ...
     * @param pharmacyData
     */
    public void setPharmacyData(PharmacyDataStruct pharmacyData) {
        this.pharmacyData = pharmacyData;
    }
     ...
     * @param alcoholData
     */
    public void setAlcoholData(AlcoholDataStruct alcoholData) {
        this.alcoholData = alcoholData;
    }
     ...
     */
    public void setRelatedPersons(RelatedPersonsStruct relatedPersons) {
        this.relatedPersons = relatedPersons;
    }

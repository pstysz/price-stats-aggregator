...
import com.stats.aggregator.allegroobj.containers.ReasonInfoType;

public class DoGetRefundsReasonsResponse  implements java.io.Serializable {
    private int reasonsCount;

    private ReasonInfoType[] reasonsList;
     ...
     * @return reasonsList
     */
    public ReasonInfoType[] getReasonsList() {
        return reasonsList;
    }
     ...
     * @param reasonsList
     */
    public void setReasonsList(ReasonInfoType[] reasonsList) {
        this.reasonsList = reasonsList;
    }

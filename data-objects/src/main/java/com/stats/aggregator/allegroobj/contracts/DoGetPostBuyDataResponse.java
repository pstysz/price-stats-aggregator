...
import com.stats.aggregator.allegroobj.containers.ItemPostBuyDataStruct;

public class DoGetPostBuyDataResponse  implements java.io.Serializable {
    private ItemPostBuyDataStruct[] itemsPostBuyData;

    public DoGetPostBuyDataResponse() {
    }

    public DoGetPostBuyDataResponse(
           ItemPostBuyDataStruct[] itemsPostBuyData) {
     ...
     */
    public ItemPostBuyDataStruct[] getItemsPostBuyData() {
        return itemsPostBuyData;
    }
     ...
     */
    public void setItemsPostBuyData(ItemPostBuyDataStruct[] itemsPostBuyData) {
        this.itemsPostBuyData = itemsPostBuyData;
    }

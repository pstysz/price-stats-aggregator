...
import com.stats.aggregator.allegroobj.containers.PostBuyFormDataStruct;

public class DoGetPostBuyFormsDataForSellersResponse  implements java.io.Serializable {
    private PostBuyFormDataStruct[] postBuyFormData;

    public DoGetPostBuyFormsDataForSellersResponse() {
    }

    public DoGetPostBuyFormsDataForSellersResponse(
           PostBuyFormDataStruct[] postBuyFormData) {
     ...
     */
    public PostBuyFormDataStruct[] getPostBuyFormData() {
        return postBuyFormData;
    }
     ...
     */
    public void setPostBuyFormData(PostBuyFormDataStruct[] postBuyFormData) {
        this.postBuyFormData = postBuyFormData;
    }

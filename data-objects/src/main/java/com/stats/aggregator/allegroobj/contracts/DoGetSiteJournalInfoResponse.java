...
import com.stats.aggregator.allegroobj.containers.SiteJournalInfo;

public class DoGetSiteJournalInfoResponse  implements java.io.Serializable {
    private SiteJournalInfo siteJournalInfo;

    public DoGetSiteJournalInfoResponse() {
    }

    public DoGetSiteJournalInfoResponse(
           SiteJournalInfo siteJournalInfo) {
     ...
     */
    public void setSiteJournalInfo(SiteJournalInfo siteJournalInfo) {
        this.siteJournalInfo = siteJournalInfo;
    }

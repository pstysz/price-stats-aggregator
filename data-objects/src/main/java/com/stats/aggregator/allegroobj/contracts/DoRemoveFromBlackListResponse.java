...
import com.stats.aggregator.allegroobj.containers.BlackListResStruct;

public class DoRemoveFromBlackListResponse  implements java.io.Serializable {
    private BlackListResStruct[] blackListResult;

    public DoRemoveFromBlackListResponse() {
    }

    public DoRemoveFromBlackListResponse(
           BlackListResStruct[] blackListResult) {
     ...
     */
    public BlackListResStruct[] getBlackListResult() {
        return blackListResult;
    }
     ...
     */
    public void setBlackListResult(BlackListResStruct[] blackListResult) {
        this.blackListResult = blackListResult;
    }

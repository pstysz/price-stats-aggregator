...
import com.stats.aggregator.allegroobj.containers.BidItemStruct;

public class DoGetMyBidItemsResponse  implements java.io.Serializable {
    private int bidItemsCounter;

    private BidItemStruct[] bidItemsList;
     ...
     * @return bidItemsList
     */
    public BidItemStruct[] getBidItemsList() {
        return bidItemsList;
    }
     ...
     * @param bidItemsList
     */
    public void setBidItemsList(BidItemStruct[] bidItemsList) {
        this.bidItemsList = bidItemsList;
    }

...
import com.stats.aggregator.allegroobj.containers.SellRatingInfoStruct;
...
public class DoGetSellRatingReasonsResponse  implements java.io.Serializable {
    ...
    public DoGetSellRatingReasonsResponse(
           SellRatingInfoStruct[] sellRatingInfo) {
     ...
     */
    public SellRatingInfoStruct[] getSellRatingInfo() {
        return sellRatingInfo;
    }
     ...
     */
    public void setSellRatingInfo(SellRatingInfoStruct[] sellRatingInfo) {
        this.sellRatingInfo = sellRatingInfo;
    }
        ...
        _equals = true && 
            ((this.sellRatingInfo==null && other.getSellRatingInfo()==null) || 
             (this.sellRatingInfo!=null &&
              java.util.Arrays.equals(this.sellRatingInfo, other.getSellRatingInfo())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getSellRatingInfo() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getSellRatingInfo());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getSellRatingInfo(), i);
                if (obj != null &&

...
import com.stats.aggregator.allegroobj.containers.SellItemStruct;

public class DoGetMySellItemsResponse  implements java.io.Serializable {
    private int sellItemsCounter;

    private SellItemStruct[] sellItemsList;
     ...
     */
    public SellItemStruct[] getSellItemsList() {
        return sellItemsList;
    }
     ...
     * @param sellItemsList
     */
    public void setSellItemsList(SellItemStruct[] sellItemsList) {
        this.sellItemsList = sellItemsList;
    }

...
import com.stats.aggregator.allegroobj.containers.RelatedItemsShipmentDataStruct;

public class DoGetShipmentDataForRelatedItemsResponse  implements java.io.Serializable {
    private RelatedItemsShipmentDataStruct relatedItemsShipmentData;

    public DoGetShipmentDataForRelatedItemsResponse() {
    }

    public DoGetShipmentDataForRelatedItemsResponse(
           RelatedItemsShipmentDataStruct relatedItemsShipmentData) {
     ...
     */
    public void setRelatedItemsShipmentData(RelatedItemsShipmentDataStruct relatedItemsShipmentData) {
        this.relatedItemsShipmentData = relatedItemsShipmentData;
    }

...
public class AddressInfoStruct  implements java.io.Serializable {
    ...
    private AddressUserDataStruct addressUserData;
    ...
    public AddressInfoStruct(
           int addressType,
           AddressUserDataStruct addressUserData) {
     ...
     */
    public void setAddressUserData(AddressUserDataStruct addressUserData) {
        this.addressUserData = addressUserData;
    }

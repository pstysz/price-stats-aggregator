...
public class DoCancelBidItemRequest  implements java.io.Serializable {
     ...
     */
    public void setCancelBidsArray(int[] cancelBidsArray) {
        this.cancelBidsArray = cancelBidsArray;
    }
        ...
        _equals = true && 
            ...
            ((this.cancelBidsArray==null && other.getCancelBidsArray()==null) || 
             (this.cancelBidsArray!=null &&
              java.util.Arrays.equals(this.cancelBidsArray, other.getCancelBidsArray()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getCancelBidsArray() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getCancelBidsArray());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getCancelBidsArray(), i);
                if (obj != null &&

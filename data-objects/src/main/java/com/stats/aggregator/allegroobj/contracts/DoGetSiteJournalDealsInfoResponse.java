...
import com.stats.aggregator.allegroobj.containers.SiteJournalDealsInfoStruct;

public class DoGetSiteJournalDealsInfoResponse  implements java.io.Serializable {
    private SiteJournalDealsInfoStruct siteJournalDealsInfo;

    public DoGetSiteJournalDealsInfoResponse() {
    }

    public DoGetSiteJournalDealsInfoResponse(
           SiteJournalDealsInfoStruct siteJournalDealsInfo) {
     ...
     */
    public void setSiteJournalDealsInfo(SiteJournalDealsInfoStruct siteJournalDealsInfo) {
        this.siteJournalDealsInfo = siteJournalDealsInfo;
    }

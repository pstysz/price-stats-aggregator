...
import com.stats.aggregator.allegroobj.containers.PostBuyItemInfoStruct;

public class DoGetPostBuyItemInfoResponse  implements java.io.Serializable {
    private PostBuyItemInfoStruct[] itemPostBuyFormInfo;

    public DoGetPostBuyItemInfoResponse() {
    }

    public DoGetPostBuyItemInfoResponse(
           PostBuyItemInfoStruct[] itemPostBuyFormInfo) {
     ...
     */
    public PostBuyItemInfoStruct[] getItemPostBuyFormInfo() {
        return itemPostBuyFormInfo;
    }
     ...
     */
    public void setItemPostBuyFormInfo(PostBuyItemInfoStruct[] itemPostBuyFormInfo) {
        this.itemPostBuyFormInfo = itemPostBuyFormInfo;
    }

...
public class PostBuyFormItemDealsStruct  implements java.io.Serializable {
    ...
    private PostBuyFormItemDealsVariantStruct dealVariant;
    ...
    public PostBuyFormItemDealsStruct(
           ...
           PostBuyFormItemDealsVariantStruct dealVariant) {
           this.dealId = dealId;
     ...
     * @param dealVariant
     */
    public void setDealVariant(PostBuyFormItemDealsVariantStruct dealVariant) {
        this.dealVariant = dealVariant;
    }

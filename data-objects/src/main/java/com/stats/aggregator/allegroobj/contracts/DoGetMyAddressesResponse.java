...
import com.stats.aggregator.allegroobj.containers.AddressInfoStruct;

public class DoGetMyAddressesResponse  implements java.io.Serializable {
    private AddressInfoStruct[] addressesInfo;

    public DoGetMyAddressesResponse() {
    }

    public DoGetMyAddressesResponse(
           AddressInfoStruct[] addressesInfo) {
     ...
     */
    public AddressInfoStruct[] getAddressesInfo() {
        return addressesInfo;
    }
     ...
     * @param addressesInfo
     */
    public void setAddressesInfo(AddressInfoStruct[] addressesInfo) {
        this.addressesInfo = addressesInfo;
    }

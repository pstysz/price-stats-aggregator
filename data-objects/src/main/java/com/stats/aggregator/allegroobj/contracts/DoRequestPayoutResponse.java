...
import com.stats.aggregator.allegroobj.containers.RequestPayoutStruct;

public class DoRequestPayoutResponse  implements java.io.Serializable {
    private RequestPayoutStruct requestPayout;

    public DoRequestPayoutResponse() {
    }

    public DoRequestPayoutResponse(
           RequestPayoutStruct requestPayout) {
     ...
     * @param requestPayout
     */
    public void setRequestPayout(RequestPayoutStruct requestPayout) {
        this.requestPayout = requestPayout;
    }

...
public class DoMyContactRequest  implements java.io.Serializable {
     ...
     * @param auctionIdList
     */
    public void setAuctionIdList(long[] auctionIdList) {
        this.auctionIdList = auctionIdList;
    }
        ...
        _equals = true && 
            ...
            ((this.auctionIdList==null && other.getAuctionIdList()==null) || 
             (this.auctionIdList!=null &&
              java.util.Arrays.equals(this.auctionIdList, other.getAuctionIdList()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getAuctionIdList() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getAuctionIdList());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getAuctionIdList(), i);
                if (obj != null &&

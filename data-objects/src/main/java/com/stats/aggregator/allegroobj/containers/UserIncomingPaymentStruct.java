...
public class UserIncomingPaymentStruct  implements java.io.Serializable {
    ...
    private PaymentDetailsStruct[] payTransDetails;
    ...
    public UserIncomingPaymentStruct(
           ...
           PaymentDetailsStruct[] payTransDetails,
     ...
     */
    public PaymentDetailsStruct[] getPayTransDetails() {
        return payTransDetails;
    }
     ...
     */
    public void setPayTransDetails(PaymentDetailsStruct[] payTransDetails) {
        this.payTransDetails = payTransDetails;
    }

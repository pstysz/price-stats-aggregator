...
public class InvoiceInfoStruct  implements java.io.Serializable {
    ...
    private AddressUserDataStruct invoiceAddressData;
    ...
    public InvoiceInfoStruct(
           ...
           AddressUserDataStruct invoiceAddressData,
     ...
     */
    public void setInvoiceAddressData(AddressUserDataStruct invoiceAddressData) {
        this.invoiceAddressData = invoiceAddressData;
    }

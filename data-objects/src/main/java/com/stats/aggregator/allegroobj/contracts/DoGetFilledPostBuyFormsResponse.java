...
import com.stats.aggregator.allegroobj.containers.FilledPostBuyFormsStruct;

public class DoGetFilledPostBuyFormsResponse  implements java.io.Serializable {
    private FilledPostBuyFormsStruct filledPostBuyForms;

    public DoGetFilledPostBuyFormsResponse() {
    }

    public DoGetFilledPostBuyFormsResponse(
           FilledPostBuyFormsStruct filledPostBuyForms) {
     ...
     */
    public void setFilledPostBuyForms(FilledPostBuyFormsStruct filledPostBuyForms) {
        this.filledPostBuyForms = filledPostBuyForms;
    }

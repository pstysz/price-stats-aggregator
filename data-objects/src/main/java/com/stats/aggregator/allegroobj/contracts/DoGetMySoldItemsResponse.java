...
import com.stats.aggregator.allegroobj.containers.SoldItemStruct;
...
public class DoGetMySoldItemsResponse  implements java.io.Serializable {
     ...
     */
    public SoldItemStruct[] getSoldItemsList() {
        return soldItemsList;
    }
     ...
     * @param soldItemsList
     */
    public void setSoldItemsList(SoldItemStruct[] soldItemsList) {
        this.soldItemsList = soldItemsList;
    }

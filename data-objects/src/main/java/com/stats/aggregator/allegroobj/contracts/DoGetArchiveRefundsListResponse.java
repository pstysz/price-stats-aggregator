...
import com.stats.aggregator.allegroobj.containers.ArchiveRefundsListTypeStruct;

public class DoGetArchiveRefundsListResponse  implements java.io.Serializable {
    private int refundsCount;

    private ArchiveRefundsListTypeStruct[] refundsList;
    ...
    public DoGetArchiveRefundsListResponse(
           int refundsCount,
           ArchiveRefundsListTypeStruct[] refundsList) {
     ...
     * @return refundsList
     */
    public ArchiveRefundsListTypeStruct[] getRefundsList() {
        return refundsList;
    }
     ...
     * @param refundsList
     */
    public void setRefundsList(ArchiveRefundsListTypeStruct[] refundsList) {
        this.refundsList = refundsList;
    }

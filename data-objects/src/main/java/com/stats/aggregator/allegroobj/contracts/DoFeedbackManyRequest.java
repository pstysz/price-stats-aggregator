...
import com.stats.aggregator.allegroobj.containers.FeedbackManyStruct;

public class DoFeedbackManyRequest  implements java.io.Serializable {
    private java.lang.String sessionHandle;

    private FeedbackManyStruct[] feedbacksList;
    ...
    public DoFeedbackManyRequest(
           ...
           FeedbackManyStruct[] feedbacksList) {
     ...
     */
    public FeedbackManyStruct[] getFeedbacksList() {
        return feedbacksList;
    }
     ...
     * @param feedbacksList
     */
    public void setFeedbacksList(FeedbackManyStruct[] feedbacksList) {
        this.feedbacksList = feedbacksList;
    }
        ...
        _equals = true && 
            ...
            ((this.feedbacksList==null && other.getFeedbacksList()==null) || 
             (this.feedbacksList!=null &&
              java.util.Arrays.equals(this.feedbacksList, other.getFeedbacksList())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getFeedbacksList() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getFeedbacksList());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getFeedbacksList(), i);
                if (obj != null &&

...
import com.stats.aggregator.allegroobj.containers.PostBuyFormStruct;

public class DoSendPostBuyFormResponse  implements java.io.Serializable {
    private PostBuyFormStruct postBuyForm;

    public DoSendPostBuyFormResponse() {
    }

    public DoSendPostBuyFormResponse(
           PostBuyFormStruct postBuyForm) {
     ...
     * @param postBuyForm
     */
    public void setPostBuyForm(PostBuyFormStruct postBuyForm) {
        this.postBuyForm = postBuyForm;
    }

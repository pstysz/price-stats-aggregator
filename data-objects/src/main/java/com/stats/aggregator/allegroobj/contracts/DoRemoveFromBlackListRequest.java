...
public class DoRemoveFromBlackListRequest  implements java.io.Serializable {
     ...
     * @param usersIdArray
     */
    public void setUsersIdArray(long[] usersIdArray) {
        this.usersIdArray = usersIdArray;
    }
        ...
        _equals = true && 
            ...
            ((this.usersIdArray==null && other.getUsersIdArray()==null) || 
             (this.usersIdArray!=null &&
              java.util.Arrays.equals(this.usersIdArray, other.getUsersIdArray())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getUsersIdArray() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getUsersIdArray());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getUsersIdArray(), i);
                if (obj != null &&

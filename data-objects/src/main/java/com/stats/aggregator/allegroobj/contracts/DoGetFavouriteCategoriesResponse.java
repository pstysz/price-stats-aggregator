...
import com.stats.aggregator.allegroobj.containers.FavouritesCategoriesStruct;

public class DoGetFavouriteCategoriesResponse  implements java.io.Serializable {
    private FavouritesCategoriesStruct[] sFavouriteCategoriesList;

    public DoGetFavouriteCategoriesResponse() {
    }

    public DoGetFavouriteCategoriesResponse(
           FavouritesCategoriesStruct[] sFavouriteCategoriesList) {
     ...
     */
    public FavouritesCategoriesStruct[] getSFavouriteCategoriesList() {
        return sFavouriteCategoriesList;
    }
     ...
     */
    public void setSFavouriteCategoriesList(FavouritesCategoriesStruct[] sFavouriteCategoriesList) {
        this.sFavouriteCategoriesList = sFavouriteCategoriesList;
    }

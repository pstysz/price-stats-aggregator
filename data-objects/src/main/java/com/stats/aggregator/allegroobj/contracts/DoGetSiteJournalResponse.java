...
import com.stats.aggregator.allegroobj.containers.SiteJournal;

public class DoGetSiteJournalResponse  implements java.io.Serializable {
    private SiteJournal[] siteJournalArray;

    public DoGetSiteJournalResponse() {
    }

    public DoGetSiteJournalResponse(
           SiteJournal[] siteJournalArray) {
     ...
     */
    public SiteJournal[] getSiteJournalArray() {
        return siteJournalArray;
    }
     ...
     */
    public void setSiteJournalArray(SiteJournal[] siteJournalArray) {
        this.siteJournalArray = siteJournalArray;
    }

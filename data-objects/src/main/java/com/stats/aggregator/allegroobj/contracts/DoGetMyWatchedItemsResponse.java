...
import com.stats.aggregator.allegroobj.containers.WatchedItemStruct;

public class DoGetMyWatchedItemsResponse  implements java.io.Serializable {
    private int watchedItemsCounter;

    private WatchedItemStruct[] watchedItemsList;
    ...
    public DoGetMyWatchedItemsResponse(
           ...
           WatchedItemStruct[] watchedItemsList) {
     ...
     */
    public WatchedItemStruct[] getWatchedItemsList() {
        return watchedItemsList;
    }
     ...
     */
    public void setWatchedItemsList(WatchedItemStruct[] watchedItemsList) {
        this.watchedItemsList = watchedItemsList;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://webapi.allegro.pl/service.php", "WatchedItemStruct"));

...
import com.stats.aggregator.allegroobj.containers.RelatedItemsStruct;

public class DoGetRelatedItemsResponse  implements java.io.Serializable {
    private RelatedItemsStruct relatedItems;

    public DoGetRelatedItemsResponse() {
    }

    public DoGetRelatedItemsResponse(
           RelatedItemsStruct relatedItems) {
     ...
     * @param relatedItems
     */
    public void setRelatedItems(RelatedItemsStruct relatedItems) {
        this.relatedItems = relatedItems;
    }

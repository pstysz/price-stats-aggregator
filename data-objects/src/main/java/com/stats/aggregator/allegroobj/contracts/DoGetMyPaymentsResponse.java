...
import com.stats.aggregator.allegroobj.containers.UserPaymentStruct;

public class DoGetMyPaymentsResponse  implements java.io.Serializable {
    private UserPaymentStruct[] payTransPayment;

    public DoGetMyPaymentsResponse() {
    }

    public DoGetMyPaymentsResponse(
           UserPaymentStruct[] payTransPayment) {
     ...
     */
    public UserPaymentStruct[] getPayTransPayment() {
        return payTransPayment;
    }
     ...
     */
    public void setPayTransPayment(UserPaymentStruct[] payTransPayment) {
        this.payTransPayment = payTransPayment;
    }

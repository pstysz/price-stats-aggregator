...
import com.stats.aggregator.allegroobj.containers.SellRatingEstimationStruct;
...
public class DoFeedbackRequest  implements java.io.Serializable {
    ...
    private SellRatingEstimationStruct[] feRating;
    ...
    public DoFeedbackRequest(
           ...
           int feOp,
           SellRatingEstimationStruct[] feRating) {
     ...
     * @return feRating
     */
    public SellRatingEstimationStruct[] getFeRating() {
        return feRating;
    }
     ...
     * @param feRating
     */
    public void setFeRating(SellRatingEstimationStruct[] feRating) {
        this.feRating = feRating;
    }

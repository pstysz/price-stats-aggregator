...
public class SellRatingAveragePerMonthStruct  implements java.io.Serializable {
    ...
    private SellRatingStatsStruct[] sellRatingAverageValues;
    ...
    public SellRatingAveragePerMonthStruct(
           ...
           SellRatingStatsStruct[] sellRatingAverageValues) {
     ...
     */
    public SellRatingStatsStruct[] getSellRatingAverageValues() {
        return sellRatingAverageValues;
    }
     ...
     */
    public void setSellRatingAverageValues(SellRatingStatsStruct[] sellRatingAverageValues) {
        this.sellRatingAverageValues = sellRatingAverageValues;
    }

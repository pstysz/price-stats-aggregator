...
import com.stats.aggregator.allegroobj.containers.SiteJournalDealsStruct;

public class DoGetSiteJournalDealsResponse  implements java.io.Serializable {
    private SiteJournalDealsStruct[] siteJournalDeals;

    public DoGetSiteJournalDealsResponse() {
    }

    public DoGetSiteJournalDealsResponse(
           SiteJournalDealsStruct[] siteJournalDeals) {
     ...
     */
    public SiteJournalDealsStruct[] getSiteJournalDeals() {
        return siteJournalDeals;
    }
     ...
     */
    public void setSiteJournalDeals(SiteJournalDealsStruct[] siteJournalDeals) {
        this.siteJournalDeals = siteJournalDeals;
    }

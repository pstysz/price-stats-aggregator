...
public class ItemPostBuyDataStruct  implements java.io.Serializable {
    ...
    private UserPostBuyDataStruct[] usersPostBuyData;
    ...
    public ItemPostBuyDataStruct(
           long itemId,
           UserPostBuyDataStruct[] usersPostBuyData) {
           this.itemId = itemId;
     ...
     */
    public UserPostBuyDataStruct[] getUsersPostBuyData() {
        return usersPostBuyData;
    }
     ...
     */
    public void setUsersPostBuyData(UserPostBuyDataStruct[] usersPostBuyData) {
        this.usersPostBuyData = usersPostBuyData;
    }

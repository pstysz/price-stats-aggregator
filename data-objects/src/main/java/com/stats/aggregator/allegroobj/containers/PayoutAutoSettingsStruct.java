...
public class PayoutAutoSettingsStruct  implements java.io.Serializable {
    ...
    private PayoutAutoFrequencyStruct payoutAutoFrequency;
    ...
    public PayoutAutoSettingsStruct(
           ...
           PayoutAutoFrequencyStruct payoutAutoFrequency) {
     ...
     */
    public void setPayoutAutoFrequency(PayoutAutoFrequencyStruct payoutAutoFrequency) {
        this.payoutAutoFrequency = payoutAutoFrequency;
    }

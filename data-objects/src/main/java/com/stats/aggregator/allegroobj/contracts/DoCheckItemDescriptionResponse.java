...
import com.stats.aggregator.allegroobj.containers.ItemDescriptionStruct;

public class DoCheckItemDescriptionResponse  implements java.io.Serializable {
    private ItemDescriptionStruct itemDescription;

    public DoCheckItemDescriptionResponse() {
    }

    public DoCheckItemDescriptionResponse(
           ItemDescriptionStruct itemDescription) {
     ...
     */
    public void setItemDescription(ItemDescriptionStruct itemDescription) {
        this.itemDescription = itemDescription;
    }

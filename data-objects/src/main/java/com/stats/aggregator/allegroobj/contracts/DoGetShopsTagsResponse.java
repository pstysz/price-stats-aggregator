...
import com.stats.aggregator.allegroobj.containers.ShopsTagTypeStruct;

public class DoGetShopsTagsResponse  implements java.io.Serializable {
    private int shopsTagsCount;

    private ShopsTagTypeStruct[] shopsTags;
     ...
     * @return shopsTags
     */
    public ShopsTagTypeStruct[] getShopsTags() {
        return shopsTags;
    }
     ...
     * @param shopsTags
     */
    public void setShopsTags(ShopsTagTypeStruct[] shopsTags) {
        this.shopsTags = shopsTags;
    }

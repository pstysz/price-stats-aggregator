...
import com.stats.aggregator.allegroobj.containers.UserPayoutStruct;

public class DoGetMyPayoutsResponse  implements java.io.Serializable {
    private UserPayoutStruct[] payTransPayout;

    public DoGetMyPayoutsResponse() {
    }

    public DoGetMyPayoutsResponse(
           UserPayoutStruct[] payTransPayout) {
     ...
     */
    public UserPayoutStruct[] getPayTransPayout() {
        return payTransPayout;
    }
     ...
     */
    public void setPayTransPayout(UserPayoutStruct[] payTransPayout) {
        this.payTransPayout = payTransPayout;
    }

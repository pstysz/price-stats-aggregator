...
import com.stats.aggregator.allegroobj.containers.ShipmentDataStruct;

public class DoGetShipmentDataResponse  implements java.io.Serializable {
    private ShipmentDataStruct[] shipmentDataList;
    ...
    public DoGetShipmentDataResponse(
           ShipmentDataStruct[] shipmentDataList,
           long localVersion) {
     ...
     */
    public ShipmentDataStruct[] getShipmentDataList() {
        return shipmentDataList;
    }
     ...
     */
    public void setShipmentDataList(ShipmentDataStruct[] shipmentDataList) {
        this.shipmentDataList = shipmentDataList;
    }

...
import com.stats.aggregator.allegroobj.containers.ChangedItemStruct;

public class DoChangeItemFieldsResponse  implements java.io.Serializable {
    private ChangedItemStruct changedItem;

    public DoChangeItemFieldsResponse() {
    }

    public DoChangeItemFieldsResponse(
           ChangedItemStruct changedItem) {
     ...
     * @param changedItem
     */
    public void setChangedItem(ChangedItemStruct changedItem) {
        this.changedItem = changedItem;
    }

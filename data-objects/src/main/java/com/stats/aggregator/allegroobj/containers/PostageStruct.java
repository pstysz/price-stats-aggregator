...
public class PostageStruct  implements java.io.Serializable {
    ...
    private FulfillmentTimeStruct postageFulfillmentTime;
    ...
    public PostageStruct(
           ...
           FulfillmentTimeStruct postageFulfillmentTime) {
     ...
     */
    public void setPostageFulfillmentTime(FulfillmentTimeStruct postageFulfillmentTime) {
        this.postageFulfillmentTime = postageFulfillmentTime;
    }

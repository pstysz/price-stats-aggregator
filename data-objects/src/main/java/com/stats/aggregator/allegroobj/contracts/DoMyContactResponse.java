...
import com.stats.aggregator.allegroobj.containers.MyContactList;
...
public class DoMyContactResponse  implements java.io.Serializable {
        ...
        _equals = true && 
            ((this.mycontactList==null && other.getMycontactList()==null) || 
             (this.mycontactList!=null &&
              java.util.Arrays.equals(this.mycontactList, other.getMycontactList())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getMycontactList() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getMycontactList());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getMycontactList(), i);
                if (obj != null &&

...
import com.stats.aggregator.allegroobj.containers.FavouritesSellersStruct;

public class DoGetFavouriteSellersResponse  implements java.io.Serializable {
    private FavouritesSellersStruct[] sFavouriteSellersList;

    public DoGetFavouriteSellersResponse() {
    }

    public DoGetFavouriteSellersResponse(
           FavouritesSellersStruct[] sFavouriteSellersList) {
     ...
     */
    public FavouritesSellersStruct[] getSFavouriteSellersList() {
        return sFavouriteSellersList;
    }
     ...
     */
    public void setSFavouriteSellersList(FavouritesSellersStruct[] sFavouriteSellersList) {
        this.sFavouriteSellersList = sFavouriteSellersList;
    }
        ...
        _equals = true && 
            ((this.sFavouriteSellersList==null && other.getSFavouriteSellersList()==null) || 
             (this.sFavouriteSellersList!=null &&
              java.util.Arrays.equals(this.sFavouriteSellersList, other.getSFavouriteSellersList())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getSFavouriteSellersList() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getSFavouriteSellersList());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getSFavouriteSellersList(), i);
                if (obj != null &&

...
import com.stats.aggregator.allegroobj.containers.BillingDataType;

public class DoGetPaymentDataResponse  implements java.io.Serializable {
    private BillingDataType[] paymentList;

    public DoGetPaymentDataResponse() {
    }

    public DoGetPaymentDataResponse(
           BillingDataType[] paymentList) {
     ...
     * @return paymentList
     */
    public BillingDataType[] getPaymentList() {
        return paymentList;
    }
     ...
     * @param paymentList
     */
    public void setPaymentList(BillingDataType[] paymentList) {
        this.paymentList = paymentList;
    }

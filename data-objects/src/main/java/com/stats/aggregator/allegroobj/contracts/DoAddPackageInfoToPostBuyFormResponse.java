...
import com.stats.aggregator.allegroobj.containers.PostBuyFormPackageInfoStruct;

public class DoAddPackageInfoToPostBuyFormResponse  implements java.io.Serializable {
    private PostBuyFormPackageInfoStruct postBuyFormPackageInfo;

    public DoAddPackageInfoToPostBuyFormResponse() {
    }

    public DoAddPackageInfoToPostBuyFormResponse(
           PostBuyFormPackageInfoStruct postBuyFormPackageInfo) {
     ...
     */
    public void setPostBuyFormPackageInfo(PostBuyFormPackageInfoStruct postBuyFormPackageInfo) {
        this.postBuyFormPackageInfo = postBuyFormPackageInfo;
    }

...
public class WebApiServiceLocator extends org.apache.axis.client.Service implements WebApiService {

    public WebApiServiceLocator() {
    }

    public WebApiServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public WebApiServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }
    ...
    public WebApiServicePort getservicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            WebApiServiceBindingStub _stub = new WebApiServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (WebApiServicePort.class.isAssignableFrom(serviceEndpointInterface)) {
                WebApiServiceBindingStub _stub = new WebApiServiceBindingStub(new java.net.URL(servicePort_address), this);
                _stub.setPortName(getservicePortWSDDServiceName());
                return _stub;
            }

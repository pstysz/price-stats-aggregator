...
public class NewPostBuyFormCommonStruct  implements java.io.Serializable {
    ...
    private AddressUserDataStruct shipmentAddressData;

    private java.lang.String contactPhone;

    private int invoiceOption;

    private InvoiceInfoStruct invoiceInfo;
    ...
    public NewPostBuyFormCommonStruct(
           ...
           AddressUserDataStruct shipmentAddressData,
           java.lang.String contactPhone,
           int invoiceOption,
           InvoiceInfoStruct invoiceInfo) {
     ...
     */
    public void setShipmentAddressData(AddressUserDataStruct shipmentAddressData) {
        this.shipmentAddressData = shipmentAddressData;
    }
     ...
     * @param invoiceInfo
     */
    public void setInvoiceInfo(InvoiceInfoStruct invoiceInfo) {
        this.invoiceInfo = invoiceInfo;
    }

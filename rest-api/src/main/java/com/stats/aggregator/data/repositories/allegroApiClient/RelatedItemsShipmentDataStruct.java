...
public class RelatedItemsShipmentDataStruct  implements java.io.Serializable {
    private SellerShipmentDataStruct[] sellerShipmentData;

    public RelatedItemsShipmentDataStruct() {
    }

    public RelatedItemsShipmentDataStruct(
           SellerShipmentDataStruct[] sellerShipmentData) {
     ...
     */
    public SellerShipmentDataStruct[] getSellerShipmentData() {
        return sellerShipmentData;
    }
     ...
     */
    public void setSellerShipmentData(SellerShipmentDataStruct[] sellerShipmentData) {
        this.sellerShipmentData = sellerShipmentData;
    }

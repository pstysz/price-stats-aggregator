...
public class PaymentsPayoutStruct  implements java.io.Serializable {
    ...
    private PayoutAutoSettingsStruct payoutAutoSettings;
    ...
    public PaymentsPayoutStruct(
           int payoutType,
           PayoutAutoSettingsStruct payoutAutoSettings) {
     ...
     */
    public void setPayoutAutoSettings(PayoutAutoSettingsStruct payoutAutoSettings) {
        this.payoutAutoSettings = payoutAutoSettings;
    }

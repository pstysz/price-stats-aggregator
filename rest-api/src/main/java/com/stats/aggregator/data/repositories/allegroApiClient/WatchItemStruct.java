...
public class WatchItemStruct  implements java.io.Serializable {
    ...
    private UserInfoStruct itemSeller;

    private int itemBiddersCounter;

    private UserInfoStruct itemHighestBidder;
    ...
    private ItemReminderStruct[] itemReminder;
    ...
    public WatchItemStruct(
           ...
           UserInfoStruct itemSeller,
           int itemBiddersCounter,
           UserInfoStruct itemHighestBidder,
           int itemCategoryId,
           ...
           int itemPayuInfo,
           ItemReminderStruct[] itemReminder) {
           this.itemId = itemId;
     ...
     * @param itemSeller
     */
    public void setItemSeller(UserInfoStruct itemSeller) {
        this.itemSeller = itemSeller;
    }
     ...
     */
    public void setItemHighestBidder(UserInfoStruct itemHighestBidder) {
        this.itemHighestBidder = itemHighestBidder;
    }
     ...
     * @return itemReminder
     */
    public ItemReminderStruct[] getItemReminder() {
        return itemReminder;
    }
     ...
     * @param itemReminder
     */
    public void setItemReminder(ItemReminderStruct[] itemReminder) {
        this.itemReminder = itemReminder;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://webapi.allegro.pl/service.php", "WatchItemStruct"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://webapi.allegro.pl/service.php", "itemReminder"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://webapi.allegro.pl/service.php", "ItemReminderStruct"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("https://webapi.allegro.pl/service.php", "item"));
        typeDesc.addFieldDesc(elemField);

...
public class VariantStruct  implements java.io.Serializable {
    ...
    private VariantQuantityStruct[] quantities;
    ...
    public VariantStruct(
           int fid,
           VariantQuantityStruct[] quantities) {
           this.fid = fid;
     ...
     * @return quantities
     */
    public VariantQuantityStruct[] getQuantities() {
        return quantities;
    }
     ...
     * @param quantities
     */
    public void setQuantities(VariantQuantityStruct[] quantities) {
        this.quantities = quantities;
    }

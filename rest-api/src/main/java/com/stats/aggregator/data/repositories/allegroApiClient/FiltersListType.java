...
public class FiltersListType  implements java.io.Serializable {
    ...
    private FilterValueType[] filterValues;

    private FilterRelationType filterRelations;
    ...
    public FiltersListType(
           ...
           FilterValueType[] filterValues,
           FilterRelationType filterRelations) {
     ...
     * @return filterValues
     */
    public FilterValueType[] getFilterValues() {
        return filterValues;
    }
     ...
     * @param filterValues
     */
    public void setFilterValues(FilterValueType[] filterValues) {
        this.filterValues = filterValues;
    }
     ...
     */
    public void setFilterRelations(FilterRelationType filterRelations) {
        this.filterRelations = filterRelations;
    }

...
public class UserPaymentStruct  implements java.io.Serializable {
    ...
    private PaymentSellersStruct[] payTransSellers;
    ...
    public UserPaymentStruct(
           long payTransId,
           PaymentSellersStruct[] payTransSellers,
     ...
     */
    public PaymentSellersStruct[] getPayTransSellers() {
        return payTransSellers;
    }
     ...
     */
    public void setPayTransSellers(PaymentSellersStruct[] payTransSellers) {
        this.payTransSellers = payTransSellers;
    }

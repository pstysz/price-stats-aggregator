...
public class FieldsValue  implements java.io.Serializable {
    ...
    private RangeIntValueStruct fvalueRangeInt;

    private RangeFloatValueStruct fvalueRangeFloat;

    private RangeDateValueStruct fvalueRangeDate;
    ...
    public FieldsValue(
           ...
           RangeIntValueStruct fvalueRangeInt,
           RangeFloatValueStruct fvalueRangeFloat,
           RangeDateValueStruct fvalueRangeDate) {
           this.fid = fid;
     ...
     */
    public void setFvalueRangeInt(RangeIntValueStruct fvalueRangeInt) {
        this.fvalueRangeInt = fvalueRangeInt;
    }
     ...
     */
    public void setFvalueRangeFloat(RangeFloatValueStruct fvalueRangeFloat) {
        this.fvalueRangeFloat = fvalueRangeFloat;
    }
     ...
     */
    public void setFvalueRangeDate(RangeDateValueStruct fvalueRangeDate) {
        this.fvalueRangeDate = fvalueRangeDate;
    }
